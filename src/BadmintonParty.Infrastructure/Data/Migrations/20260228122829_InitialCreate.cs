        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineOfficalAccount = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourtHalls", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courts_CourtHalls_HallId",
                        column: x => x.HallId,
                        principalTable: "CourtHalls",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CourtId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberRecentOpenings", x => new { x.MemberId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourtHalls_PublicId",
                table: "CourtHalls",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Courts_HallId",
                table: "Courts",
                column: "HallId");

            migrationBuilder.CreateIndex(
                name: "IX_Courts_PublicId",
                table: "Courts",
                column: "PublicId",
                unique: true);
